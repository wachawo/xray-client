...
def main() -> int:
    ...
    parser.add_argument('--remove-env', action='store_true', help='Also remove .env file')
    ...
    tun2socks_image_id = get_container_image_id('xray_tun2socks') if docker_available() else None
